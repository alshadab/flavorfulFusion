...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto p-5 md:p-10 bg-gray-50 shadow-lg rounded-lg">
      ...
      <p className="mb-4 text-gray-600">
        ...
        full. If you disagree with any part of these terms, you must not use our
        website.
      </p>
      ...
      <p className="mb-4 text-gray-600">
        By placing an order, you are making an offer to purchase a product. All
      ...
      <p className="mb-4 text-gray-600">
        We aim to deliver products within the estimated delivery times. However,
        we are not liable for any delays caused by events outside our control.
      </p>
      ...
      <p className="mb-4 text-gray-600">
        If you are not satisfied with your purchase, please refer to our Return
        Policy for information on how to return products.
      </p>
